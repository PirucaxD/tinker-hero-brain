...
Current build: **Tinker.lua v0.1.250**.
...
- `tools/run_tests.lua` - the offline test suite (717 tests, no game needed).
...
```
lua tools/run_tests.lua          # pure-Lua suite, expect 717 passing
